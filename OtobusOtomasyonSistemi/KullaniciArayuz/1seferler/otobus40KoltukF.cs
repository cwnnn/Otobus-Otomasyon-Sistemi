...
{
    public partial class otobus40KoltukF : Form
    {
        ...
        public otobus40KoltukF(FormKullaniciArayuz kullaniciArayuz)
        {
            InitializeComponent();
        ...
        private void otobus40KoltukF_Load(object sender, EventArgs e)
        {
            labelUyari.Text = "";
        ...
        private void guna2ImageButton38_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void panellerYenileme()
        {
            ...
            Panel[] panelListesi = { panel1, panel2, panel3, panel4 };
            Label[] labels = { labelPanel1, labelPanel2, labelPanel3, labelPanel4 };
            byte sayac = 0;
        ...
        {
            baglan.Open();
            string sorgu = @"SELECT b.koltukNo, y.cinsiyet
FROM Biletler b
